<template>
  <div>
    <div>
                ...
                <el-table :data="patientData"
                  ...
                  <el-table-column align="center" fixed="right" label="操作" width="120">
                    <template slot-scope="scope">
                      <el-tooltip class="item" effect="dark" content="选择此病人，并开立处置项目" placement="right">
      ...
      <div>
        <el-divider content-position="center">患者处置项目表</el-divider>
      </div>
      <el-row :gutter="20">
        <el-col :span="24">
          <el-card shadow="hover">
                ...
                <el-table :data="itemData"
                  ...
                  <el-table-column align="center" prop="state" label="状态" :formatter="applyState" width="113px">
                    <template slot-scope="scope">
                      ...
                      <el-tag v-if="scope.row.state === 0" type="danger" size="mini">已作废</el-tag>
                    </template>
                  </el-table-column>
                      ...
                      <el-button-group>
                        <div>
                          ...
                          <el-popover
                              ...
                              width="400"
                              trigger="click">
                            <el-descriptions :data="scope.row" size="mini" title="患者处置结果信息" direction="vertical" :column="4" border>
