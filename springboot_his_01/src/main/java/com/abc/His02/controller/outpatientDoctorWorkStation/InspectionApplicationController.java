...
import com.abc.His02.service.outpatientDoctorWorkStationService.InspectionApplicationService;
...
public class InspectionApplicationController {
     ...
     * @description 初始化待申请检查的患者
     */
    @PostMapping("/outpatientDoctorWorkStation/inspectionApplication/initPatients")
...
//        System.out.println("caseNumber = " + caseNumber);
        ...
        try {
            for (int i=0; i<caseNumber.size(); i++) {
                System.out.println("caseNumber[" + i + "] = " + caseNumber.get(i).getCaseNumber()
                        + caseNumber.get(i).getRealName() + caseNumber.get(i).getAge());
    ...
    /**
     * @return {@link ResultUtil}
     * @description 初始化患者的检查申请
     */
    @RequestMapping("/outpatientDoctorWorkStation/inspectionApplication/initApply")
    public ResultUtil initApply(MedicalRecord medicalRecord) {
        System.out.println("即将查询的检查申请的患者：" + medicalRecord);
        List<CheckApply> result = new ArrayList<>();
        Integer code = EnumCode.OK.getValue();
        String msg = "已加载检查申请信息";
        boolean flag = true;
        try {
    ...
    /**
     * @return {@link ResultUtil}
     * @description 暂存患者的检查申请
     */
    @PostMapping("/outpatientDoctorWorkStation/inspectionApplication/tempApply")
    ...
    /**
     * @return {@link ResultUtil}
     * @description 开立患者的检查申请
     */
    @PostMapping("/outpatientDoctorWorkStation/inspectionApplication/commitApply")
    ...
    /**
     * @return {@link ResultUtil}
     * @description 删除患者的检查申请
     */
    @PostMapping("/outpatientDoctorWorkStation/inspectionApplication/deleteApply")
    ...
    /**
     * @return {@link ResultUtil}
     * @description 作废患者的检查申请
     */
    @PostMapping("/outpatientDoctorWorkStation/inspectionApplication/cancelApply")
    ...
    /**
     * @return {@link ResultUtil}
     * @description 修改患者的检查申请
     */
    @PostMapping("/outpatientDoctorWorkStation/inspectionApplication/editApply")
     ...
     * @description 生成项目的名称
     */
    @PostMapping("/outpatientDoctorWorkStation/inspectionApplication/initItemName")
    ...
    /**
     * @return {@link ResultUtil}
     * @description 添加患者的检查项目
     */
    @PostMapping("/outpatientDoctorWorkStation/inspectionApplication/addApply")
